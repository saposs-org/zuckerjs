...
ZuckerJS's concept:
> Hiding the complexity and creating SPA web application by writing or reusing components(view, handler and service components). Then, ZuckerJS loads them and render web page based upon user's requests.
